...
[assembly:ModelsBuilderAssembly(PureLive = true, SourceHash = "af55b8d6720ea5e4")]
...
namespace Umbraco.Web.PublishedContentModels
{
	...
	public partial class Home : PublishedContentModel, IFeaturedItemsControls, IFixedBackgroundImageBlock, IIntroControls, ILatestBlogPostsControls, IServicesControls
	{
...
#pragma warning restore 0109
		...
		{
			get { return FixedBackgroundImageBlock.GetFixedImage(this); }
		}

		///<summary>
		/// Fixed Image Block Link: Add a redirect link for the fixed image block button
		///</summary>
		[ImplementPropertyType("fixedImageBlockLink")]
		public Newtonsoft.Json.Linq.JArray FixedImageBlockLink
		{
			get { return FixedBackgroundImageBlock.GetFixedImageBlockLink(this); }
		}

		///<summary>
		/// Fixed Image Text: Add the text that goes on top on the image
		///</summary>
		[ImplementPropertyType("fixedImageText")]
		public IHtmlString FixedImageText
		{
			get { return FixedBackgroundImageBlock.GetFixedImageText(this); }
		}

		///<summary>
		/// Fixed Image Text - Title: Add a title for the text on top of the image
		///</summary>
		[ImplementPropertyType("fixedImageTextTitle")]
		public string FixedImageTextTitle
		{
			get { return FixedBackgroundImageBlock.GetFixedImageTextTitle(this); }
		}
		...
		///<summary>
		/// Latest Blog Posts Introduction
		///</summary>
		...
		///<summary>
		/// Services Conclusion: Please add some words for after services area
		///</summary>
		[ImplementPropertyType("servicesConclusion")]
		public IHtmlString ServicesConclusion
		{
			get { return ServicesControls.GetServicesConclusion(this); }
		}

		///<summary>
		/// Services Intro: Please add a intro text for the Services area
		///</summary>
		[ImplementPropertyType("servicesIntro")]
		public IHtmlString ServicesIntro
		{
			get { return ServicesControls.GetServicesIntro(this); }
		}
		...
		public Newtonsoft.Json.Linq.JArray ServicesLink
		{
			get { return ServicesControls.GetServicesLink(this); }
		}

		///<summary>
		/// Services Title: Add a title for the Services section
		///</summary>
...
#pragma warning restore 0109
	...
	[PublishedContentModel("porrtofolio")]
	public partial class Porrtofolio : PublishedContentModel, ITitleControls
	{
#pragma warning disable 0109 // new is redundant
		public new const string ModelTypeAlias = "porrtofolio";
		public new const PublishedItemType ModelItemType = PublishedItemType.Content;
#pragma warning restore 0109

		public Porrtofolio(IPublishedContent content)
			: base(content)
		{ }
...
#pragma warning restore 0109
		...
		public static PublishedPropertyType GetModelPropertyType<TValue>(Expression<Func<Porrtofolio, TValue>> selector)
		{
			return PublishedContentModelUtility.GetModelPropertyType(GetModelContentType(), selector);
		}
...
#pragma warning restore 0109
		...
		///<summary>
		/// Exclude from top navigation: tick this if you don't want you page to appear in the top navigation
		///</summary>
...
#pragma warning restore 0109
	...
	// Mixin content Type 1077 with alias "topNavigationControls"
...
#pragma warning restore 0109
	...
	// Mixin content Type 1083 with alias "articleControls"
...
#pragma warning restore 0109
	...
	// Mixin content Type 1097 with alias "latestBlogPostsControls"
...
#pragma warning restore 0109
	...
	// Mixin content Type 1098 with alias "prettyLinkControls"
	...
	public partial interface IPrettyLinkControls : IPublishedContent
	{
		...
		Newtonsoft.Json.Linq.JArray LinkTarget { get; }
	}
...
#pragma warning restore 0109
		...
		public Newtonsoft.Json.Linq.JArray LinkTarget
		{
			get { return GetLinkTarget(this); }
		}

		/// <summary>Static getter for Link Target</summary>
		public static Newtonsoft.Json.Linq.JArray GetLinkTarget(IPrettyLinkControls that) { return that.GetPropertyValue<Newtonsoft.Json.Linq.JArray>("linkTarget"); }
	}
...
#pragma warning restore 0109
		...
		public Newtonsoft.Json.Linq.JArray LinkTarget
		{
			get { return PrettyLinkControls.GetLinkTarget(this); }
		}
	}

	// Mixin content Type 1102 with alias "servicesControls"
	/// <summary>Services Controls</summary>
	public partial interface IServicesControls : IPublishedContent
	{
		/// <summary>Services Conclusion</summary>
		IHtmlString ServicesConclusion { get; }

		/// <summary>Services Intro</summary>
		IHtmlString ServicesIntro { get; }

		/// <summary>Services Link</summary>
		Newtonsoft.Json.Linq.JArray ServicesLink { get; }
...
#pragma warning restore 0109
		...
		public IHtmlString ServicesConclusion
		{
			get { return GetServicesConclusion(this); }
		}

		/// <summary>Static getter for Services Conclusion</summary>
		public static IHtmlString GetServicesConclusion(IServicesControls that) { return that.GetPropertyValue<IHtmlString>("servicesConclusion"); }
		...
		public static Newtonsoft.Json.Linq.JArray GetServicesLink(IServicesControls that) { return that.GetPropertyValue<Newtonsoft.Json.Linq.JArray>("servicesLink"); }
	...
	// Mixin content Type 1104 with alias "fixedBackgroundImageBlock"
	...
	public partial interface IFixedBackgroundImageBlock : IPublishedContent
	{
		...
		string FixedImage { get; }

		/// <summary>Fixed Image Block Link</summary>
		Newtonsoft.Json.Linq.JArray FixedImageBlockLink { get; }

		/// <summary>Fixed Image Text</summary>
		IHtmlString FixedImageText { get; }

		/// <summary>Fixed Image Text - Title</summary>
		string FixedImageTextTitle { get; }
	}
...
#pragma warning restore 0109
		...
		public static string GetFixedImage(IFixedBackgroundImageBlock that) { return that.GetPropertyValue<string>("fixedImage"); }
		...
		public static Newtonsoft.Json.Linq.JArray GetFixedImageBlockLink(IFixedBackgroundImageBlock that) { return that.GetPropertyValue<Newtonsoft.Json.Linq.JArray>("fixedImageBlockLink"); }
		...
		public IHtmlString FixedImageText
		{
			get { return GetFixedImageText(this); }
		}

		/// <summary>Static getter for Fixed Image Text</summary>
		public static IHtmlString GetFixedImageText(IFixedBackgroundImageBlock that) { return that.GetPropertyValue<IHtmlString>("fixedImageText"); }
		...
		public string FixedImageTextTitle
		{
			get { return GetFixedImageTextTitle(this); }
		}

		/// <summary>Static getter for Fixed Image Text - Title</summary>
		public static string GetFixedImageTextTitle(IFixedBackgroundImageBlock that) { return that.GetPropertyValue<string>("fixedImageTextTitle"); }
	}
...
#pragma warning restore 0109
		...
		///<summary>
		/// Alt image: add text for the alt attribute
		///</summary>
		[ImplementPropertyType("altImage")]
		public string AltImage
		{
			get { return this.GetPropertyValue<string>("altImage"); }
		}
